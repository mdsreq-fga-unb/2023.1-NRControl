...
function EmployeePage() {
    ...
    useEffect(() => {
      if (id) {
        axios.get(`http://localhost:3005/employeeinfo/byId/${id}`).then((response) => {
    ...
    <div classname='postPage'>
      ...
      <div className='post' id='individual'>
        ...
        <div className='birthday'>Data de nascimento: {employeeObject.birthday}</div>
        <div className='admissiondate'>Data de admissão: {employeeObject.admissiondate}</div>
